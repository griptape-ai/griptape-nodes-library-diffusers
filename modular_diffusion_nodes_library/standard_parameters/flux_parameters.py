...
class FluxPipelineParameters(ModularDiffusionPipelineTypePipelineParameters):
    _pipeline_cls_path = "diffusers:FluxPipeline"
    ...
    def text_conditioning_width(cls, resolve_config) -> int | None:
        return cls._extract_text_conditioning_width(resolve_config("text_encoder_2"))
    ...
    @classmethod
    def _build_pipeline_from_repo(cls, build_data: dict[str, Any], overrides: dict[str, Any]) -> diffusers.FluxPipeline:  # type: ignore[reportAttributeAccessIssue]
