...
# Approximate hidden-size activation buffers per token: 3 (QKV) + 1 (attention
# output/residual) + 4 (FFN intermediate) = roughly 8. This is a coarse heuristic
# for combined temporary inference buffers, not an exact tensor-liveness calculation.
